          ...
          children: <Widget>[
            ...
            SizedBox(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Land Address:', style: TextStyle(fontSize: 18)),
                    Flexible(
                      child: Container(
                        width: isDesktop ? 375 : scrWidth * 0.8,
                        child: Padding(
            ...
            SizedBox(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Land Price:', style: TextStyle(fontSize: 18)),
                    Flexible(
                      child: Container(
                        width: isDesktop ? 375 : scrWidth * 0.8,
                        padding: const EdgeInsets.all(10),
            ...
            SizedBox(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Property ID:', style: TextStyle(fontSize: 18)),
                    Flexible(
                      child: Container(
                        width: isDesktop ? 375 : scrWidth * 0.8,
                        child: Padding(
            ...
            SizedBox(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Survey No. :', style: TextStyle(fontSize: 18)),
                  Flexible(
                      child: Container(
                    width: isDesktop ? 375 : scrWidth * 0.8,
                    child: Padding(
                  ...
                  children: [
                    Container(
                      ...
                      child: Flexible(
                        child: Padding(
                          padding: isDesktop
                              ? EdgeInsets.only(left: 50, bottom: 40, top: 40)
                              : EdgeInsets.all(10),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              MaterialButton(
                                color: Color(0xFF603500),
                                shape: RoundedRectangleBorder(
                                    borderRadius:
                                        BorderRadius.all(Radius.circular(10)),
                                    side: BorderSide(style: BorderStyle.solid)),
                                textColor: Color(0xFFEEE2D4),
